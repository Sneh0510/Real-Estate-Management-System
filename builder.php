    ...
    <div class="row"> 
        ...
        <!-- <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Builder</b></h2>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="full-row">
            <div class="container">
				<div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Builder</h2>
                        </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hover-zoomer bg-white shadow-one mb-4">
                            ...
                            <div class="py-3 text-center">
                                ...
                                <span>Real Estate - Builder</span> </div>
                        </div>
                    </div>
