<footer class="full-row bg-secondary p-0">
            <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Collins ,South bopal 8007, Ahemdabad</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>92463 45695</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>92463 45695</li>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2024 Homex All right reserved</span> </div>
                    <div class="col-sm-6">
